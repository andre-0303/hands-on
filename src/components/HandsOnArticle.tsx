...
import type { areas, handsOns } from "@/db/schema";
import { LEVEL_LABEL, stepTitle } from "@/lib/handson";
import { InlineMarkdown, Markdown } from "@/components/Markdown";
import { ProgressProvider, ProgressSummary, StepNumber, StepToggle } from "@/components/Progress";

type HandsOn = typeof handsOns.$inferSelect;
type Area = typeof areas.$inferSelect;

export function HandsOnArticle({ handsOn: h, area }: { handsOn: HandsOn; area: Area }) {
  const stepLinks = (
  ...
  return (
    <ProgressProvider slug={h.slug} total={h.steps.length}>
